"""
SpaceX-Falcon-9-type-lander experiment using a feed-forward neural network.
"""
...
def run():
    ...
    #pop = neat.Checkpointer.restore_checkpoint(os.path.join(local_dir, 'neat-checkpoint-760'))
    ...
    winner = pop.run(pe.evaluate, 800)
